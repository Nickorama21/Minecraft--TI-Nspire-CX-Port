...
public class ComponentScatteredFeatureDesertPyramid extends ComponentScatteredFeature
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.stairsSandStone.blockID, var4, this.field_74939_a - 3, 10, 0, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.stairsSandStone.blockID, var5, this.field_74939_a - 3, 10, 4, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.stairsSandStone.blockID, var6, this.field_74939_a - 5, 10, 2, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.stairsSandStone.blockID, var7, this.field_74939_a - 1, 10, 2, par3StructureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.stairsSandStone.blockID, var4, this.field_74939_a - 3, 4, 5, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.stairsSandStone.blockID, var4, this.field_74939_a - 3, 3, 4, par3StructureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.stairsSandStone.blockID, 0, this.field_74939_a - 2, 1, 2, par3StructureBoundingBox);
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.stairsSandStone.blockID, var6, this.field_74939_a - 3, 1, 2, par3StructureBoundingBox);
