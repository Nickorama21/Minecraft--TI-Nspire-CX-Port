...
public class GuiOptions extends GuiScreen
{
     ...
     */
    private static final EnumOptions[] relevantOptions = new EnumOptions[] {EnumOptions.INVERT_MOUSE, EnumOptions.SENSITIVITY, EnumOptions.FOV, EnumOptions.DIFFICULTY};
