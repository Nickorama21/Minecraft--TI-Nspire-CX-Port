...
public class MovingObjectPosition
{
    ...
    public MovingObjectPosition(int par1, int par2, int par3, int par4, Vec3 par5Vec3)
    {
        ...
        this.blockZ = par3;
        this.sideHit = par4;
        this.hitVec = Vec3.func_72437_a().func_72345_a(par5Vec3.xCoord, par5Vec3.yCoord, par5Vec3.zCoord);
    }
    ...
    public MovingObjectPosition(Entity par1Entity)
    {
        ...
        this.hitVec = Vec3.func_72437_a().func_72345_a(par1Entity.posX, par1Entity.posY, par1Entity.posZ);
    }
}
