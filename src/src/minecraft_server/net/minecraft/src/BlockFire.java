...
public class BlockFire extends Block
{
    ...
    public void initializeBlock()
    {
        ...
        this.setBurnRate(Block.field_72072_bX.blockID, 5, 20);
        this.setBurnRate(Block.field_72074_bW.blockID, 5, 20);
        this.setBurnRate(Block.field_72070_bY.blockID, 5, 20);
