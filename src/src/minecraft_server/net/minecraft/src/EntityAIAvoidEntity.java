...
public class EntityAIAvoidEntity extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        {
            Vec3 var2 = RandomPositionGenerator.func_75461_b(this.theEntity, 16, 7, Vec3.func_72437_a().func_72345_a(this.closestLivingEntity.posX, this.closestLivingEntity.posY, this.closestLivingEntity.posZ));
