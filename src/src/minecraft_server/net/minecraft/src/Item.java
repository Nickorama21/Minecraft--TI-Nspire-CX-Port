...
public class Item
{
    ...
    public static Item diamond = (new Item(8)).setIconCoord(7, 3).setItemName("diamond").func_77637_a(CreativeTabs.field_78035_l);
    ...
    public static Item flint = (new Item(62)).setIconCoord(6, 0).setItemName("flint").func_77637_a(CreativeTabs.field_78035_l);
    ...
    public static Item writableBook = (new ItemWritableBook(130)).setIconCoord(11, 11).setItemName("writingBook").func_77637_a(CreativeTabs.field_78026_f);
    public static Item field_77823_bG = (new ItemEditableBook(131)).setIconCoord(12, 11).setItemName("writtenBook");
    public static Item emerald = (new Item(132)).setIconCoord(10, 11).setItemName("emerald").func_77637_a(CreativeTabs.field_78035_l);
