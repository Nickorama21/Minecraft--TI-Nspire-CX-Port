...
public abstract class StructureComponent
{
    ...
    protected int getMetadataWithOffset(int par1, int par2)
    {
        ...
        {
            if (par1 != Block.stairCompactCobblestone.blockID && par1 != Block.stairCompactPlanks.blockID && par1 != Block.stairsNetherBrick.blockID && par1 != Block.stairsStoneBrickSmooth.blockID && par1 != Block.field_72088_bQ.blockID)
            {
                ...
                else if (par1 != Block.field_72064_bT.blockID && (Block.blocksList[par1] == null || !(Block.blocksList[par1] instanceof BlockDirectional)))
                {
