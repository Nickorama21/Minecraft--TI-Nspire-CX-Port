        ...
        while (var6 < 2)
        {
            ...
            while (true)
            {
                if (var7 < 42)
                {
                    ...
                    if (var10 == Block.field_72064_bT.blockID)
                    {
                        int var11 = par1World.getBlockMetadata(var8, par3, var9) & 3;

                        if (var11 == Direction.footInvisibleFaceRemap[var6])
                        {
                            Block.field_72064_bT.func_72143_a(par1World, var8, par3, var9, var10, par1World.getBlockMetadata(var8, par3, var9), true, var7, par5);
                        }
                    }
                    else if (var10 == Block.field_72062_bU.blockID)
                    {
                        ++var7;
                        continue;
                    }
