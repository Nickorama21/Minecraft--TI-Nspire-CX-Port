...
public class ItemReed extends Item
{
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        {
            if (par3World.func_72931_a(this.spawnID, par4, par5, par6, false, par7, (Entity)null))
            {
                ...
                if (par3World.setBlockWithNotify(par4, par5, par6, this.spawnID))
                {
                    ...
                    {
                        Block.blocksList[this.spawnID].func_71909_a(par3World, par4, par5, par6, par7, par8, par9, par10);
