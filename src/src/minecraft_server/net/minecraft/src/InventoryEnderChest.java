...
public class InventoryEnderChest extends InventoryBasic
{
    ...
    {
        this.field_70488_a = par1TileEntityEnderChest;
    }
    ...
    {
        return this.field_70488_a != null && !this.field_70488_a.isUseableByPlayer(par1EntityPlayer) ? false : super.isUseableByPlayer(par1EntityPlayer);
    }
