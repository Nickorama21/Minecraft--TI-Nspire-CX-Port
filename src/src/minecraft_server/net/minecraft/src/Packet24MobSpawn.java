...
public class Packet24MobSpawn extends Packet
{
    ...
    public Packet24MobSpawn(EntityLiving par1EntityLiving)
    {
        ...
        this.xPosition = par1EntityLiving.field_70168_am.func_75630_a(par1EntityLiving.posX);
        this.yPosition = MathHelper.floor_double(par1EntityLiving.posY * 32.0D);
        this.zPosition = par1EntityLiving.field_70168_am.func_75630_a(par1EntityLiving.posZ);
