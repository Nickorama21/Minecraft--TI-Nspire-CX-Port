        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        Vec3 var3 = RandomPositionGenerator.func_75464_a(this.theEntity, 10, 7, Vec3.func_72437_a().func_72345_a((double)this.doorInfo.posX, (double)this.doorInfo.posY, (double)this.doorInfo.posZ));
