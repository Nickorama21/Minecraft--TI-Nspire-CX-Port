...
public class ChunkProviderEnd implements IChunkProvider
{
    ...
    public void func_73189_a(int par1, int par2, byte[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
    {
        byte var5 = 2;
        int var6 = var5 + 1;
        byte var7 = 33;
        int var8 = var5 + 1;
        this.densities = this.func_73187_a(this.densities, par1 * var5, 0, par2 * var5, var6, var7, var8);
    ...
    public void func_73188_b(int par1, int par2, byte[] par3ArrayOfByte, BiomeGenBase[] par4ArrayOfBiomeGenBase)
    {
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        this.func_73189_a(par1, par2, var3, this.biomesForGeneration);
        this.func_73188_b(par1, par2, var3, this.biomesForGeneration);
    ...
    private double[] func_73187_a(double[] par1ArrayOfDouble, int par2, int par3, int par4, int par5, int par6, int par7)
    {
