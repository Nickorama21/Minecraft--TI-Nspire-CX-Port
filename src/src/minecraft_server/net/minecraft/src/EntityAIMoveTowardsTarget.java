...
public class EntityAIMoveTowardsTarget extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        {
            Vec3 var1 = RandomPositionGenerator.func_75464_a(this.theEntity, 16, 7, Vec3.func_72437_a().func_72345_a(this.targetEntity.posX, this.targetEntity.posY, this.targetEntity.posZ));
