...
public class ComponentScatteredFeatureDesertPyramid extends ComponentScatteredFeature
{
    ...
    {
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 0, -4, 0, this.field_74939_a - 1, 0, this.field_74938_c - 1, Block.sandStone.blockID, Block.sandStone.blockID, false);
        int var4;

        for (var4 = 1; var4 <= 9; ++var4)
        {
            this.fillWithBlocks(par1World, par3StructureBoundingBox, var4, var4, var4, this.field_74939_a - 1 - var4, var4, this.field_74938_c - 1 - var4, Block.sandStone.blockID, Block.sandStone.blockID, false);
            this.fillWithBlocks(par1World, par3StructureBoundingBox, var4 + 1, var4, var4 + 1, this.field_74939_a - 2 - var4, var4, this.field_74938_c - 2 - var4, 0, 0, false);
        }
        ...
        var4 = this.getMetadataWithOffset(Block.field_72088_bQ.blockID, 3);
        var5 = this.getMetadataWithOffset(Block.field_72088_bQ.blockID, 2);
        int var6 = this.getMetadataWithOffset(Block.field_72088_bQ.blockID, 0);
        int var7 = this.getMetadataWithOffset(Block.field_72088_bQ.blockID, 1);
        byte var8 = 1;
        byte var9 = 11;
        ...
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var4, 2, 10, 0, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var5, 2, 10, 4, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var6, 0, 10, 2, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var7, 4, 10, 2, par3StructureBoundingBox);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, this.field_74939_a - 5, 0, 0, this.field_74939_a - 1, 9, 4, Block.sandStone.blockID, 0, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, this.field_74939_a - 4, 10, 1, this.field_74939_a - 2, 10, 3, Block.sandStone.blockID, Block.sandStone.blockID, false);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var4, this.field_74939_a - 3, 10, 0, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var5, this.field_74939_a - 3, 10, 4, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var6, this.field_74939_a - 5, 10, 2, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var7, this.field_74939_a - 1, 10, 2, par3StructureBoundingBox);
        ...
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 5, 4, 5, this.field_74939_a - 6, 4, this.field_74938_c - 6, Block.sandStone.blockID, Block.sandStone.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 9, 4, 9, 11, 4, 11, 0, 0, false);
        this.func_74872_a(par1World, par3StructureBoundingBox, 8, 1, 8, 8, 3, 8, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        this.func_74872_a(par1World, par3StructureBoundingBox, 12, 1, 8, 12, 3, 8, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        this.func_74872_a(par1World, par3StructureBoundingBox, 8, 1, 12, 8, 3, 12, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        this.func_74872_a(par1World, par3StructureBoundingBox, 12, 1, 12, 12, 3, 12, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        ...
        this.fillWithBlocks(par1World, par3StructureBoundingBox, this.field_74939_a - 5, 1, 5, this.field_74939_a - 2, 4, 11, Block.sandStone.blockID, Block.sandStone.blockID, false);
        ...
        this.fillWithBlocks(par1World, par3StructureBoundingBox, this.field_74939_a - 7, 7, 9, this.field_74939_a - 7, 7, 11, Block.sandStone.blockID, Block.sandStone.blockID, false);
        this.func_74872_a(par1World, par3StructureBoundingBox, 5, 5, 9, 5, 7, 11, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        this.func_74872_a(par1World, par3StructureBoundingBox, this.field_74939_a - 6, 5, 9, this.field_74939_a - 6, 7, 11, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        ...
        this.placeBlockAtCurrentPosition(par1World, 0, 0, this.field_74939_a - 6, 5, 10, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, 0, 0, this.field_74939_a - 6, 6, 10, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, 0, 0, this.field_74939_a - 7, 6, 10, par3StructureBoundingBox);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 2, 4, 4, 2, 6, 4, 0, 0, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, this.field_74939_a - 3, 4, 4, this.field_74939_a - 3, 6, 4, 0, 0, false);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var4, 2, 4, 5, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var4, 2, 3, 4, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var4, this.field_74939_a - 3, 4, 5, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var4, this.field_74939_a - 3, 3, 4, par3StructureBoundingBox);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 1, 1, 3, 2, 2, 3, Block.sandStone.blockID, Block.sandStone.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, this.field_74939_a - 3, 1, 3, this.field_74939_a - 2, 2, 3, Block.sandStone.blockID, Block.sandStone.blockID, false);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, 0, 1, 1, 2, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, 0, this.field_74939_a - 2, 1, 2, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.stoneSingleSlab.blockID, 1, 1, 2, 2, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.stoneSingleSlab.blockID, 1, this.field_74939_a - 2, 2, 2, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var7, 2, 1, 2, par3StructureBoundingBox);
        this.placeBlockAtCurrentPosition(par1World, Block.field_72088_bQ.blockID, var6, this.field_74939_a - 3, 1, 2, par3StructureBoundingBox);
        ...
        this.fillWithBlocks(par1World, par3StructureBoundingBox, this.field_74939_a - 5, 3, 5, this.field_74939_a - 5, 3, 17, Block.sandStone.blockID, Block.sandStone.blockID, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 3, 1, 5, 4, 2, 16, 0, 0, false);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, this.field_74939_a - 6, 1, 5, this.field_74939_a - 5, 2, 16, 0, 0, false);
        int var10;
        ...
        for (var10 = 5; var10 <= 17; var10 += 2)
        {
            ...
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 2, this.field_74939_a - 5, 1, var10, par3StructureBoundingBox);
            this.placeBlockAtCurrentPosition(par1World, Block.sandStone.blockID, 1, this.field_74939_a - 5, 2, var10, par3StructureBoundingBox);
        }
        ...
        this.func_74872_a(par1World, par3StructureBoundingBox, 8, 4, 0, 12, 6, 0, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        ...
        this.func_74872_a(par1World, par3StructureBoundingBox, 8, -14, 8, 12, -11, 12, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
        this.func_74872_a(par1World, par3StructureBoundingBox, 8, -10, 8, 12, -10, 12, Block.sandStone.blockID, 1, Block.sandStone.blockID, 1, false);
        this.func_74872_a(par1World, par3StructureBoundingBox, 8, -9, 8, 12, -9, 12, Block.sandStone.blockID, 2, Block.sandStone.blockID, 2, false);
