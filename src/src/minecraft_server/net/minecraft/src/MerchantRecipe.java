...
public class MerchantRecipe
{
    ...
    {
        this.func_77390_a(par1NBTTagCompound);
    }
    ...
    {
        return this.func_77393_a(par1MerchantRecipe) && (this.itemToBuy.stackSize < par1MerchantRecipe.itemToBuy.stackSize || this.secondItemToBuy != null && this.secondItemToBuy.stackSize < par1MerchantRecipe.secondItemToBuy.stackSize);
    }
