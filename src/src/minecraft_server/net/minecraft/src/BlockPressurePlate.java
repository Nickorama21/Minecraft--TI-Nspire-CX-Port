...
public class BlockPressurePlate extends Block
{
    ...
    {
        return par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) || BlockFence.func_72249_c(par1World.getBlockId(par2, par3 - 1, par4));
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        if (!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) && !BlockFence.func_72249_c(par1World.getBlockId(par2, par3 - 1, par4)))
        {
            var6 = true;
        }
