...
import org.bouncycastle.jce.provider.BouncyCastleProviderAction;
...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
   ...
   private void func_74819_a(String p_74819_1_, String[] p_74819_2_) {
      for(int var3 = 0; var3 != p_74819_2_.length; ++var3) {
         Class var4 = null;

         try {
            ClassLoader var5 = this.getClass().getClassLoader();
            if(var5 != null) {
               var4 = var5.loadClass(p_74819_1_ + p_74819_2_[var3] + "$Mappings");
            } else {
               var4 = Class.forName(p_74819_1_ + p_74819_2_[var3] + "$Mappings");
            }
         ...
         if(var4 != null) {
            try {
               ...
               throw new InternalError("cannot create instance of " + p_74819_1_ + p_74819_2_[var3] + "$Mappings : " + var6);
            }
         }
      }
   ...
   // $FF: synthetic method
   static void func_74821_a(BouncyCastleProvider p_74821_0_) {
      p_74821_0_.func_74818_a();
   }
