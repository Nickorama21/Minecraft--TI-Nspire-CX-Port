...
public class ModelEnderman extends ModelBiped {
   ...
   public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_) {
      ...
      this.field_78115_e.field_78797_d = var7;
      ...
      float var8 = 0.4F;
      if(this.field_78112_f.field_78795_f > var8) {
         this.field_78112_f.field_78795_f = var8;
      }

      if(this.field_78113_g.field_78795_f > var8) {
         this.field_78113_g.field_78795_f = var8;
      }
      ...
      if(this.field_78123_h.field_78795_f > var8) {
         this.field_78123_h.field_78795_f = var8;
      }

      if(this.field_78124_i.field_78795_f > var8) {
         this.field_78124_i.field_78795_f = var8;
      }
      ...
      this.field_78123_h.field_78797_d = 9.0F + var7;
      this.field_78124_i.field_78797_d = 9.0F + var7;
      this.field_78116_c.field_78798_e = -0.0F;
      this.field_78116_c.field_78797_d = var7 + 1.0F;
      ...
      if(this.field_78125_b) {
         float var9 = 1.0F;
         this.field_78116_c.field_78797_d -= var9 * 5.0F;
      }
