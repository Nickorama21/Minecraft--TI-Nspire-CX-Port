...
public class ModelVillager extends ModelBase {
   ...
   public ModelVillager(float p_i3139_1_, float p_i3139_2_) {
      ...
      this.field_78191_a.func_78793_a(0.0F, 0.0F + p_i3139_2_, 0.0F);
      this.field_78191_a.func_78784_a(0, 0).func_78790_a(-4.0F, -10.0F, -4.0F, 8, 10, 8, p_i3139_1_);
      this.field_78191_a.func_78784_a(24, 0).func_78790_a(-1.0F, -3.0F, -6.0F, 2, 4, 2, p_i3139_1_);
      this.field_78189_b = (new ModelRenderer(this)).func_78787_b(var3, var4);
      this.field_78189_b.func_78793_a(0.0F, 0.0F + p_i3139_2_, 0.0F);
      this.field_78189_b.func_78784_a(16, 20).func_78790_a(-4.0F, 0.0F, -3.0F, 8, 12, 6, p_i3139_1_);
      this.field_78189_b.func_78784_a(0, 38).func_78790_a(-4.0F, 0.0F, -3.0F, 8, 18, 6, p_i3139_1_ + 0.5F);
      this.field_78190_c = (new ModelRenderer(this)).func_78787_b(var3, var4);
      this.field_78190_c.func_78793_a(0.0F, 0.0F + p_i3139_2_ + 2.0F, 0.0F);
      this.field_78190_c.func_78784_a(44, 22).func_78790_a(-8.0F, -2.0F, -2.0F, 4, 8, 4, p_i3139_1_);
      this.field_78190_c.func_78784_a(44, 22).func_78790_a(4.0F, -2.0F, -2.0F, 4, 8, 4, p_i3139_1_);
      this.field_78190_c.func_78784_a(40, 38).func_78790_a(-4.0F, 2.0F, -2.0F, 8, 4, 4, p_i3139_1_);
      this.field_78187_d = (new ModelRenderer(this, 0, 22)).func_78787_b(var3, var4);
      this.field_78187_d.func_78793_a(-2.0F, 12.0F + p_i3139_2_, 0.0F);
      this.field_78187_d.func_78790_a(-2.0F, 0.0F, -2.0F, 4, 12, 4, p_i3139_1_);
      this.field_78188_e = (new ModelRenderer(this, 0, 22)).func_78787_b(var3, var4);
      this.field_78188_e.field_78809_i = true;
      this.field_78188_e.func_78793_a(2.0F, 12.0F + p_i3139_2_, 0.0F);
      this.field_78188_e.func_78790_a(-2.0F, 0.0F, -2.0F, 4, 12, 4, p_i3139_1_);
   }
