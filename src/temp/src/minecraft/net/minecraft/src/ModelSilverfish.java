...
public class ModelSilverfish extends ModelBase {
   ...
   public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_) {
      for(int var7 = 0; var7 < this.field_78171_a.length; ++var7) {
         this.field_78171_a[var7].field_78796_g = MathHelper.func_76134_b(p_78087_3_ * 0.9F + (float)var7 * 0.15F * 3.1415927F) * 3.1415927F * 0.05F * (float)(1 + Math.abs(var7 - 2));
         this.field_78171_a[var7].field_78800_c = MathHelper.func_76126_a(p_78087_3_ * 0.9F + (float)var7 * 0.15F * 3.1415927F) * 3.1415927F * 0.2F * (float)Math.abs(var7 - 2);
      }
