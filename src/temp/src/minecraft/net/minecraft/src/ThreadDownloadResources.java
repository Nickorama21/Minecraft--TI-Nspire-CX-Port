...
public class ThreadDownloadResources extends Thread {
   ...
   private void func_74576_a(File p_74576_1_, String p_74576_2_) {
      ...
      for(int var6 = 0; var6 < var5; ++var6) {
         File var7 = var4[var6];
         if(var7.isDirectory()) {
            this.func_74576_a(var7, p_74576_2_ + var7.getName() + "/");
         } else {
            try {
               this.field_74577_b.func_71360_a(p_74576_2_ + var7.getName(), var7);
            } catch (Exception var9) {
               System.out.println("Failed to add " + p_74576_2_ + var7.getName());
            }
         }
      }
