...
class RailLogic {
   ...
   private boolean func_73647_b(RailLogic p_73647_1_) {
      Iterator var2 = this.field_73654_g.iterator();
      ...
      } while(var3.field_76930_a != p_73647_1_.field_73658_c || var3.field_76929_c != p_73647_1_.field_73656_e);

      return true;
   }

   private boolean func_73649_b(int p_73649_1_, int p_73649_2_, int p_73649_3_) {
      Iterator var4 = this.field_73654_g.iterator();
      ...
      } while(var5.field_76930_a != p_73649_1_ || var5.field_76929_c != p_73649_3_);
   ...
   public void func_73652_a(boolean p_73652_1_, boolean p_73652_2_) {
      ...
      if(p_73652_2_ || this.field_73657_b.func_72805_g(this.field_73658_c, this.field_73655_d, this.field_73656_e) != var8) {
         ...
         Iterator var9 = this.field_73654_g.iterator();

         while(var9.hasNext()) {
            ChunkPosition var10 = (ChunkPosition)var9.next();
            RailLogic var11 = this.func_73648_a(var10);
            if(var11 != null) {
               var11.func_73644_a();
               if(var11.func_73646_c(this)) {
                  var11.func_73641_d(this);
               }
            }
         }
      }
