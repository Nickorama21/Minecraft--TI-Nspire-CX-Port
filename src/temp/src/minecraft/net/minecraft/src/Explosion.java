...
public class Explosion {
   ...
   public void func_77278_a() {
            ...
            for(var5 = 0; var5 < this.field_77289_h; ++var5) {
               if(var3 == 0 || var3 == this.field_77289_h - 1 || var4 == 0 || var4 == this.field_77289_h - 1 || var5 == 0 || var5 == this.field_77289_h - 1) {
                  ...
                  for(float var21 = 0.3F; var14 > 0.0F; var14 -= var21 * 0.75F) {
                     ...
                     if(var25 > 0) {
                        var14 -= (Block.field_71973_m[var25].func_71904_a(this.field_77283_e) + 0.3F) * var21;
                     }
      ...
      int var27 = MathHelper.func_76128_c(this.field_77285_c + (double)this.field_77280_f + 1.0D);
      int var7 = MathHelper.func_76128_c(this.field_77282_d - (double)this.field_77280_f - 1.0D);
      int var28 = MathHelper.func_76128_c(this.field_77282_d + (double)this.field_77280_f + 1.0D);
      List var9 = this.field_77287_j.func_72839_b(this.field_77283_e, AxisAlignedBB.func_72332_a().func_72299_a((double)var3, (double)var5, (double)var7, (double)var4, (double)var27, (double)var28));
      Vec3 var29 = Vec3.func_72437_a().func_72345_a(this.field_77284_b, this.field_77285_c, this.field_77282_d);

      for(int var11 = 0; var11 < var9.size(); ++var11) {
         Entity var30 = (Entity)var9.get(var11);
         double var13 = var30.func_70011_f(this.field_77284_b, this.field_77285_c, this.field_77282_d) / (double)this.field_77280_f;
         if(var13 <= 1.0D) {
            var15 = var30.field_70165_t - this.field_77284_b;
            var17 = var30.field_70163_u + (double)var30.func_70047_e() - this.field_77285_c;
            var19 = var30.field_70161_v - this.field_77282_d;
            double var32 = (double)MathHelper.func_76133_a(var15 * var15 + var17 * var17 + var19 * var19);
            if(var32 != 0.0D) {
               var15 /= var32;
               var17 /= var32;
               var19 /= var32;
               double var31 = (double)this.field_77287_j.func_72842_a(var29, var30.field_70121_D);
               double var33 = (1.0D - var13) * var31;
               var30.func_70097_a(DamageSource.field_76378_k, (int)((var33 * var33 + var33) / 2.0D * 8.0D * (double)this.field_77280_f + 1.0D));
               var30.field_70159_w += var15 * var33;
               var30.field_70181_x += var17 * var33;
               var30.field_70179_y += var19 * var33;
   ...
   public void func_77279_a(boolean p_77279_1_) {
      ...
      while(var2.hasNext()) {
         ...
         if(var7 > 0) {
            Block.field_71973_m[var7].func_71914_a(this.field_77287_j, var4, var5, var6, this.field_77287_j.func_72805_g(var4, var5, var6), 0.3F, 0);
            ...
            Block.field_71973_m[var7].func_71867_k(this.field_77287_j, var4, var5, var6);
         }
      }
