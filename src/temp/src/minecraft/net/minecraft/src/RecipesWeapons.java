   ...
   public void func_77583_a(CraftingManager p_77583_1_) {
      for(int var2 = 0; var2 < this.field_77584_b[0].length; ++var2) {
         ...
         for(int var4 = 0; var4 < this.field_77584_b.length - 1; ++var4) {
            ...
            p_77583_1_.func_77595_a(new ItemStack(var5), new Object[]{this.field_77585_a[var4], Character.valueOf('#'), Item.field_77669_D, Character.valueOf('X'), var3});
         }
      }

      p_77583_1_.func_77595_a(new ItemStack(Item.field_77707_k, 1), new Object[]{" #X", "# X", " #X", Character.valueOf('X'), Item.field_77683_K, Character.valueOf('#'), Item.field_77669_D});
      p_77583_1_.func_77595_a(new ItemStack(Item.field_77704_l, 4), new Object[]{"X", "#", "Y", Character.valueOf('Y'), Item.field_77676_L, Character.valueOf('X'), Item.field_77804_ap, Character.valueOf('#'), Item.field_77669_D});
   }
}
