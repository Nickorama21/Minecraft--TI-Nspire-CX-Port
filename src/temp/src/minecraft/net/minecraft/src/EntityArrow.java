...
public class EntityArrow extends Entity {
   ...
   public EntityArrow(World p_i3567_1_, EntityLiving p_i3567_2_, EntityLiving p_i3567_3_, float p_i3567_4_, float p_i3567_5_) {
      ...
      if(var12 >= 1.0E-7D) {
         ...
         this.func_70244_c(var6, var8 + (double)var20, var10, p_i3567_4_, p_i3567_5_);
      }
   }
   ...
   public EntityArrow(World p_i3568_1_, EntityLiving p_i3568_2_, float p_i3568_3_) {
      ...
      this.func_70244_c(this.field_70159_w, this.field_70181_x, this.field_70179_y, p_i3568_3_ * 1.5F, 1.0F);
   }
   ...
   public void func_70244_c(double p_70244_1_, double p_70244_3_, double p_70244_5_, float p_70244_7_, float p_70244_8_) {
      float var9 = MathHelper.func_76133_a(p_70244_1_ * p_70244_1_ + p_70244_3_ * p_70244_3_ + p_70244_5_ * p_70244_5_);
      p_70244_1_ /= (double)var9;
      p_70244_3_ /= (double)var9;
      p_70244_5_ /= (double)var9;
      p_70244_1_ += this.field_70146_Z.nextGaussian() * 0.007499999832361937D * (double)p_70244_8_;
      p_70244_3_ += this.field_70146_Z.nextGaussian() * 0.007499999832361937D * (double)p_70244_8_;
      p_70244_5_ += this.field_70146_Z.nextGaussian() * 0.007499999832361937D * (double)p_70244_8_;
      p_70244_1_ *= (double)p_70244_7_;
      p_70244_3_ *= (double)p_70244_7_;
      p_70244_5_ *= (double)p_70244_7_;
      this.field_70159_w = p_70244_1_;
      this.field_70181_x = p_70244_3_;
      this.field_70179_y = p_70244_5_;
      float var10 = MathHelper.func_76133_a(p_70244_1_ * p_70244_1_ + p_70244_5_ * p_70244_5_);
      this.field_70126_B = this.field_70177_z = (float)(Math.atan2(p_70244_1_, p_70244_5_) * 180.0D / 3.1415927410125732D);
      this.field_70127_C = this.field_70125_A = (float)(Math.atan2(p_70244_3_, (double)var10) * 180.0D / 3.1415927410125732D);
   ...
   public void func_70071_h_() {
      ...
      if(var16 > 0) {
         ...
         if(var2 != null && var2.func_72318_a(Vec3.func_72437_a().func_72345_a(this.field_70165_t, this.field_70163_u, this.field_70161_v))) {
      ...
      if(this.field_70254_i) {
         ...
         ++this.field_70257_an;
         Vec3 var17 = Vec3.func_72437_a().func_72345_a(this.field_70165_t, this.field_70163_u, this.field_70161_v);
         Vec3 var3 = Vec3.func_72437_a().func_72345_a(this.field_70165_t + this.field_70159_w, this.field_70163_u + this.field_70181_x, this.field_70161_v + this.field_70179_y);
         MovingObjectPosition var4 = this.field_70170_p.func_72831_a(var17, var3, false, true);
         var17 = Vec3.func_72437_a().func_72345_a(this.field_70165_t, this.field_70163_u, this.field_70161_v);
         var3 = Vec3.func_72437_a().func_72345_a(this.field_70165_t + this.field_70159_w, this.field_70163_u + this.field_70181_x, this.field_70161_v + this.field_70179_y);
         if(var4 != null) {
            var3 = Vec3.func_72437_a().func_72345_a(var4.field_72307_f.field_72450_a, var4.field_72307_f.field_72448_b, var4.field_72307_f.field_72449_c);
         }
            ...
            if(var4.field_72308_g != null) {
               ...
               if(var4.field_72308_g.func_70097_a(var22, var24)) {
                  if(var4.field_72308_g instanceof EntityLiving) {
                     ++((EntityLiving)var4.field_72308_g).field_70719_bd;
         ...
         if(this.func_70241_g()) {
            for(int var21 = 0; var21 < 4; ++var21) {
               this.field_70170_p.func_72869_a("crit", this.field_70165_t + this.field_70159_w * (double)var21 / 4.0D, this.field_70163_u + this.field_70181_x * (double)var21 / 4.0D, this.field_70161_v + this.field_70179_y * (double)var21 / 4.0D, -this.field_70159_w, -this.field_70181_x + 0.2D, -this.field_70179_y);
            }
         }
