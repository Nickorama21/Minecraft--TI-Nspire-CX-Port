...
public class CommandGameMode extends CommandBase {
   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) {
      if(p_71515_2_.length > 0) {
         ...
         EntityPlayer var4 = p_71515_2_.length >= 2?this.func_71540_a(p_71515_2_[1]):func_71521_c(p_71515_1_);
   ...
   protected EntityPlayer func_71540_a(String p_71540_1_) {
      EntityPlayerMP var2 = MinecraftServer.func_71276_C().func_71203_ab().func_72361_f(p_71540_1_);
      if(var2 == null) {
