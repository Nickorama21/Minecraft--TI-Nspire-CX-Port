...
public abstract class EntityAITarget extends EntityAIBase {
   ...
   protected boolean func_75296_a(EntityLiving p_75296_1_, boolean p_75296_2_) {
      if(p_75296_1_ == null) {
         ...
         return false;
      } else if(p_75296_1_.field_70121_D.field_72337_e > this.field_75299_d.field_70121_D.field_72338_b && p_75296_1_.field_70121_D.field_72338_b < this.field_75299_d.field_70121_D.field_72337_e) {
         if(!this.field_75299_d.func_70686_a(p_75296_1_.getClass())) {
            return false;
         } else {
