...
import net.minecraft.src.ItemBlockSilverfish;
...
import net.minecraft.src.ItemSandStone;
import net.minecraft.src.ItemSapling;
import net.minecraft.src.ItemSlab;
import net.minecraft.src.ItemSmoothStone;
import net.minecraft.src.ItemStack;
import net.minecraft.src.ItemTree;
import net.minecraft.src.ItemWood;
...
public class Block {
   ...
   public static final StepSound field_71972_l = new StepSoundSand("sand", 1.0F, 1.0F);
   ...
   public static final Block field_72058_az = (new BlockCrops(59, 88)).func_71848_c(0.0F).func_71884_a(field_71965_g).func_71864_b("crops").func_71896_v().func_71912_p();
   ...
   public static final Block field_72055_aF = (new BlockLadder(65, 83)).func_71848_c(0.4F).func_71884_a(field_71967_e).func_71864_b("ladder").func_71912_p();
   ...
   public static final Block field_72034_aR = (new BlockButton(77, field_71981_t.field_72059_bZ)).func_71848_c(0.5F).func_71884_a(field_71976_h).func_71864_b("button").func_71912_p();
   public static final Block field_72037_aS = (new BlockSnow(78, 66)).func_71848_c(0.1F).func_71884_a(field_71975_k).func_71864_b("snow").func_71912_p().func_71868_h(0);
   ...
   public static final Block field_72039_aU = (new BlockSnowBlock(80, 66)).func_71848_c(0.2F).func_71884_a(field_71975_k).func_71864_b("snow");
   ...
   public void func_71893_a(World p_71893_1_, EntityPlayer p_71893_2_, int p_71893_3_, int p_71893_4_, int p_71893_5_, int p_71893_6_) {
      ...
      if(this.func_71906_q_() && EnchantmentHelper.func_77502_d(p_71893_2_.field_71071_by)) {
         ItemStack var8 = this.func_71880_c_(p_71893_6_);
         if(var8 != null) {
            this.func_71929_a(p_71893_1_, p_71893_3_, p_71893_4_, p_71893_5_, var8);
         }
      } else {
         int var7 = EnchantmentHelper.func_77517_e(p_71893_2_.field_71071_by);
