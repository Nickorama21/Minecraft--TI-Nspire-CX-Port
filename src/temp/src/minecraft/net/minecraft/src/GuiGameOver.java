...
public class GuiGameOver extends GuiScreen {
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      this.func_73732_a(this.field_73886_k, StatCollector.func_74838_a("deathScreen.score") + ": \u00a7e" + this.field_73882_e.field_71439_g.func_71037_bA(), this.field_73880_f / 2, 100, 16777215);
