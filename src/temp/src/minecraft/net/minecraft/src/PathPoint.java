...
public class PathPoint {
   ...
   public boolean field_75842_i = false;


   public PathPoint(int p_i3901_1_, int p_i3901_2_, int p_i3901_3_) {
      this.field_75839_a = p_i3901_1_;
      this.field_75837_b = p_i3901_2_;
      this.field_75838_c = p_i3901_3_;
      this.field_75840_j = func_75830_a(p_i3901_1_, p_i3901_2_, p_i3901_3_);
   }
