...
public class ModelBiped extends ModelBase {
   ...
   public ModelBiped(float p_i3135_1_, float p_i3135_2_) {
      ...
      this.field_78122_k.func_78790_a(-5.0F, 0.0F, -1.0F, 10, 16, 1, p_i3135_1_);
      this.field_78121_j = new ModelRenderer(this, 24, 0);
      this.field_78121_j.func_78790_a(-3.0F, -6.0F, -1.0F, 6, 6, 1, p_i3135_1_);
      this.field_78116_c = new ModelRenderer(this, 0, 0);
      this.field_78116_c.func_78790_a(-4.0F, -8.0F, -4.0F, 8, 8, 8, p_i3135_1_);
      this.field_78116_c.func_78793_a(0.0F, 0.0F + p_i3135_2_, 0.0F);
      this.field_78114_d = new ModelRenderer(this, 32, 0);
      this.field_78114_d.func_78790_a(-4.0F, -8.0F, -4.0F, 8, 8, 8, p_i3135_1_ + 0.5F);
      this.field_78114_d.func_78793_a(0.0F, 0.0F + p_i3135_2_, 0.0F);
      this.field_78115_e = new ModelRenderer(this, 16, 16);
      this.field_78115_e.func_78790_a(-4.0F, 0.0F, -2.0F, 8, 12, 4, p_i3135_1_);
      this.field_78115_e.func_78793_a(0.0F, 0.0F + p_i3135_2_, 0.0F);
      this.field_78112_f = new ModelRenderer(this, 40, 16);
      this.field_78112_f.func_78790_a(-3.0F, -2.0F, -2.0F, 4, 12, 4, p_i3135_1_);
      this.field_78112_f.func_78793_a(-5.0F, 2.0F + p_i3135_2_, 0.0F);
      this.field_78113_g = new ModelRenderer(this, 40, 16);
      this.field_78113_g.field_78809_i = true;
      this.field_78113_g.func_78790_a(-1.0F, -2.0F, -2.0F, 4, 12, 4, p_i3135_1_);
      this.field_78113_g.func_78793_a(5.0F, 2.0F + p_i3135_2_, 0.0F);
      this.field_78123_h = new ModelRenderer(this, 0, 16);
      this.field_78123_h.func_78790_a(-2.0F, 0.0F, -2.0F, 4, 12, 4, p_i3135_1_);
      this.field_78123_h.func_78793_a(-2.0F, 12.0F + p_i3135_2_, 0.0F);
      this.field_78124_i = new ModelRenderer(this, 0, 16);
      this.field_78124_i.field_78809_i = true;
      this.field_78124_i.func_78790_a(-2.0F, 0.0F, -2.0F, 4, 12, 4, p_i3135_1_);
      this.field_78124_i.func_78793_a(2.0F, 12.0F + p_i3135_2_, 0.0F);
   }
   ...
   public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_) {
      ...
      if(this.field_78095_p > -9990.0F) {
         var7 = this.field_78095_p;
         this.field_78115_e.field_78796_g = MathHelper.func_76126_a(MathHelper.func_76129_c(var7) * 3.1415927F * 2.0F) * 0.2F;
         ...
         var7 = 1.0F - this.field_78095_p;
         var7 *= var7;
         var7 *= var7;
         var7 = 1.0F - var7;
         var8 = MathHelper.func_76126_a(var7 * 3.1415927F);
         float var9 = MathHelper.func_76126_a(this.field_78095_p * 3.1415927F) * -(this.field_78116_c.field_78795_f - 0.7F) * 0.75F;
         this.field_78112_f.field_78795_f = (float)((double)this.field_78112_f.field_78795_f - ((double)var8 * 1.2D + (double)var9));
