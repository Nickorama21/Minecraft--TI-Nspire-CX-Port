      ...
      if(p_73688_0_.trim().length() < 2) {
         ...
         if(var10000 <= var7) {
            ...
            try {
               ...
               field_73696_b.log(Level.WARNING, "Could not read creation date format for ban entry \'" + var2.func_73684_a() + "\' (was: \'" + var1[var7] + "\')", var6);
            }
            ...
            if(var10000 <= var7) {
               ...
               if(var10000 <= var7) {
                  ...
                  try {
                     ...
                     field_73696_b.log(Level.WARNING, "Could not read expiry date format for ban entry \'" + var2.func_73684_a() + "\' (was: \'" + var1[var7] + "\')", var5);
                  }
