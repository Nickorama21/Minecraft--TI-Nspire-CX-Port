...
import net.minecraft.src.Vec3LocalPool;
...
public class Vec3 {
   ...
   protected Vec3(double p_i4034_1_, double p_i4034_3_, double p_i4034_5_) {
      ...
      this.field_72450_a = p_i4034_1_;
      this.field_72448_b = p_i4034_3_;
      this.field_72449_c = p_i4034_5_;
   }
   ...
   public Vec3 func_72444_a(Vec3 p_72444_1_) {
      return func_72437_a().func_72345_a(p_72444_1_.field_72450_a - this.field_72450_a, p_72444_1_.field_72448_b - this.field_72448_b, p_72444_1_.field_72449_c - this.field_72449_c);
   }
   ...
   public Vec3 func_72432_b() {
      ...
      return var1 < 1.0E-4D?func_72437_a().func_72345_a(0.0D, 0.0D, 0.0D):func_72437_a().func_72345_a(this.field_72450_a / var1, this.field_72448_b / var1, this.field_72449_c / var1);
   }
   ...
   public Vec3 func_72431_c(Vec3 p_72431_1_) {
      return func_72437_a().func_72345_a(this.field_72448_b * p_72431_1_.field_72449_c - this.field_72449_c * p_72431_1_.field_72448_b, this.field_72449_c * p_72431_1_.field_72450_a - this.field_72450_a * p_72431_1_.field_72449_c, this.field_72450_a * p_72431_1_.field_72448_b - this.field_72448_b * p_72431_1_.field_72450_a);
   }

   public Vec3 func_72441_c(double p_72441_1_, double p_72441_3_, double p_72441_5_) {
      return func_72437_a().func_72345_a(this.field_72450_a + p_72441_1_, this.field_72448_b + p_72441_3_, this.field_72449_c + p_72441_5_);
   }
   ...
   public Vec3 func_72429_b(Vec3 p_72429_1_, double p_72429_2_) {
      ...
      if(var4 * var4 < 1.0000000116860974E-7D) {
         ...
         return var10 >= 0.0D && var10 <= 1.0D?func_72437_a().func_72345_a(this.field_72450_a + var4 * var10, this.field_72448_b + var6 * var10, this.field_72449_c + var8 * var10):null;
      }
   }
