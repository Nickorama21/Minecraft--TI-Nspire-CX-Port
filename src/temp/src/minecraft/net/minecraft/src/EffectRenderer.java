...
public class EffectRenderer {
   ...
   public void func_78867_a(int p_78867_1_, int p_78867_2_, int p_78867_3_, int p_78867_4_) {
      ...
      if(var5 != 0) {
         ...
         float var7 = 0.1F;
         double var8 = (double)p_78867_1_ + this.field_78875_d.nextDouble() * (var6.field_72021_ck - var6.field_72026_ch - (double)(var7 * 2.0F)) + (double)var7 + var6.field_72026_ch;
         double var10 = (double)p_78867_2_ + this.field_78875_d.nextDouble() * (var6.field_72022_cl - var6.field_72023_ci - (double)(var7 * 2.0F)) + (double)var7 + var6.field_72023_ci;
         double var12 = (double)p_78867_3_ + this.field_78875_d.nextDouble() * (var6.field_72019_cm - var6.field_72024_cj - (double)(var7 * 2.0F)) + (double)var7 + var6.field_72024_cj;
         if(p_78867_4_ == 0) {
            var10 = (double)p_78867_2_ + var6.field_72023_ci - (double)var7;
         }

         if(p_78867_4_ == 1) {
            var10 = (double)p_78867_2_ + var6.field_72022_cl + (double)var7;
         }

         if(p_78867_4_ == 2) {
            var12 = (double)p_78867_3_ + var6.field_72024_cj - (double)var7;
         }

         if(p_78867_4_ == 3) {
            var12 = (double)p_78867_3_ + var6.field_72019_cm + (double)var7;
         }

         if(p_78867_4_ == 4) {
            var8 = (double)p_78867_1_ + var6.field_72026_ch - (double)var7;
         }

         if(p_78867_4_ == 5) {
            var8 = (double)p_78867_1_ + var6.field_72021_ck + (double)var7;
         }
