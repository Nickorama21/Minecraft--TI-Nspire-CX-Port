...
public class EntityAIMoveTwardsRestriction extends EntityAIBase {
   ...
   public boolean func_75250_a() {
      if(this.field_75436_a.func_70611_aB()) {
         ...
         Vec3 var2 = RandomPositionGenerator.func_75464_a(this.field_75436_a, 16, 7, Vec3.func_72437_a().func_72345_a((double)var1.field_71574_a, (double)var1.field_71572_b, (double)var1.field_71573_c));
         if(var2 == null) {
            return false;
         } else {
