...
public class BlockFlower extends Block {
   ...
   protected BlockFlower(int p_i3922_1_, int p_i3922_2_, Material p_i3922_3_) {
      super(p_i3922_1_, p_i3922_3_);
      this.field_72059_bZ = p_i3922_2_;
      this.func_71907_b(true);
      float var4 = 0.2F;
      this.func_71905_a(0.5F - var4, 0.0F, 0.5F - var4, 0.5F + var4, var4 * 3.0F, 0.5F + var4);
      this.func_71849_a(CreativeTabs.field_78031_c);
   }

   protected BlockFlower(int p_i3923_1_, int p_i3923_2_) {
      this(p_i3923_1_, p_i3923_2_, Material.field_76254_j);
   }
   ...
   protected final void func_72262_c(World p_72262_1_, int p_72262_2_, int p_72262_3_, int p_72262_4_) {
      if(!this.func_71854_d(p_72262_1_, p_72262_2_, p_72262_3_, p_72262_4_)) {
         ...
         p_72262_1_.func_72859_e(p_72262_2_, p_72262_3_, p_72262_4_, 0);
      }
