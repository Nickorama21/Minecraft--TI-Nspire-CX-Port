...
public class EntityAIMoveIndoors extends EntityAIBase {
   ...
   public void func_75249_e() {
      ...
      if(this.field_75424_a.func_70092_e((double)this.field_75422_b.func_75471_a(), (double)this.field_75422_b.field_75479_b, (double)this.field_75422_b.func_75472_c()) > 256.0D) {
         Vec3 var1 = RandomPositionGenerator.func_75464_a(this.field_75424_a, 14, 3, Vec3.func_72437_a().func_72345_a((double)this.field_75422_b.func_75471_a() + 0.5D, (double)this.field_75422_b.func_75473_b(), (double)this.field_75422_b.func_75472_c() + 0.5D));
         if(var1 != null) {
