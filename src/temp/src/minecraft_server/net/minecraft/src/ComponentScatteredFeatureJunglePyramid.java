...
import net.minecraft.src.ComponentScatteredFeaturePieces2;
import net.minecraft.src.Item;
import net.minecraft.src.StructureBoundingBox;
import net.minecraft.src.StructureScatteredFeatureStones;
...
public class ComponentScatteredFeatureJunglePyramid extends ComponentScatteredFeature {
   ...
   private static final WeightedRandomChestContent[] field_74944_m = new WeightedRandomChestContent[]{new WeightedRandomChestContent(Item.field_77704_l.field_77779_bT, 0, 2, 7, 30)};
   ...
   public boolean func_74875_a(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
      if(!this.func_74935_a(p_74875_1_, p_74875_3_, 0)) {
         ...
         if(!this.field_74947_h) {
            this.field_74947_h = this.func_74879_a(p_74875_1_, p_74875_3_, p_74875_2_, 8, -3, 3, field_74943_l, 2 + p_74875_2_.nextInt(5));
         }
         ...
         if(!this.field_74948_i) {
            this.field_74948_i = this.func_74879_a(p_74875_1_, p_74875_3_, p_74875_2_, 9, -3, 10, field_74943_l, 2 + p_74875_2_.nextInt(5));
         }
