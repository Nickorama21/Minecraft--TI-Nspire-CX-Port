   ...
   public void func_77586_a(CraftingManager p_77586_1_) {
      for(int var2 = 0; var2 < this.field_77587_b[0].length; ++var2) {
         ...
         for(int var4 = 0; var4 < this.field_77587_b.length - 1; ++var4) {
            ...
            p_77586_1_.func_77595_a(new ItemStack(var5), new Object[]{this.field_77588_a[var4], Character.valueOf('#'), Item.field_77669_D, Character.valueOf('X'), var3});
         }
      }

      p_77586_1_.func_77595_a(new ItemStack(Item.field_77745_be), new Object[]{" #", "# ", Character.valueOf('#'), Item.field_77703_o});
   }
}
