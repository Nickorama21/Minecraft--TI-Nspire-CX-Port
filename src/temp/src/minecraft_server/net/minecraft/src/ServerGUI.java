...
import net.minecraft.src.ServerGuiCommandListener;
import net.minecraft.src.ServerGuiFocusAdapter;
import net.minecraft.src.ServerWindowAdapter;
...
public class ServerGUI extends JComponent {
   ...
   private JComponent func_79005_d() {
      ...
      field_79010_a.addHandler(new GuiLogOutputHandler(var2));
