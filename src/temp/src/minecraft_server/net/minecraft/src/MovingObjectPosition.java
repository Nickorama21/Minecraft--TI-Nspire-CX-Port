...
public class MovingObjectPosition {
   ...
   public MovingObjectPosition(int p_i4032_1_, int p_i4032_2_, int p_i4032_3_, int p_i4032_4_, Vec3 p_i4032_5_) {
      ...
      this.field_72307_f = Vec3.func_72437_a().func_72345_a(p_i4032_5_.field_72450_a, p_i4032_5_.field_72448_b, p_i4032_5_.field_72449_c);
   }

   public MovingObjectPosition(Entity p_i4033_1_) {
      this.field_72313_a = EnumMovingObjectType.ENTITY;
      this.field_72308_g = p_i4033_1_;
      this.field_72307_f = Vec3.func_72437_a().func_72345_a(p_i4033_1_.field_70165_t, p_i4033_1_.field_70163_u, p_i4033_1_.field_70161_v);
   }
}
