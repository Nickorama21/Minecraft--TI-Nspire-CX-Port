...
public class EntityAIWatchClosest extends EntityAIBase {
   ...
   public EntityAIWatchClosest(EntityLiving p_i3472_1_, Class p_i3472_2_, float p_i3472_3_) {
      this.field_75332_b = p_i3472_1_;
      this.field_75329_f = p_i3472_2_;
      this.field_75333_c = p_i3472_3_;
   ...
   public EntityAIWatchClosest(EntityLiving p_i3473_1_, Class p_i3473_2_, float p_i3473_3_, float p_i3473_4_) {
      this.field_75332_b = p_i3473_1_;
      this.field_75329_f = p_i3473_2_;
      this.field_75333_c = p_i3473_3_;
      this.field_75331_e = p_i3473_4_;
      this.func_75248_a(2);
   }
