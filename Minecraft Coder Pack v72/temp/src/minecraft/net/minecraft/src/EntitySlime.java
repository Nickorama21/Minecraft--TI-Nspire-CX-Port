   ...
   public void func_70071_h_() {
      ...
      if(this.field_70122_E && !var1) {
         ...
         if(this.func_70804_p()) {
            this.field_70170_p.func_72956_a(this, this.func_70803_o(), this.func_70599_aP(), ((this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.2F + 1.0F) / 0.8F);
         }
   ...
   public void func_70100_b_(EntityPlayer p_70100_1_) {
      if(this.func_70800_m()) {
         ...
         if(this.func_70685_l(p_70100_1_) && this.func_70068_e(p_70100_1_) < 0.6D * (double)var2 * 0.6D * (double)var2 && p_70100_1_.func_70097_a(DamageSource.func_76358_a(this), this.func_70805_n())) {
            this.field_70170_p.func_72956_a(this, "mob.slimeattack", 1.0F, (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.2F + 1.0F);
         }
      }
