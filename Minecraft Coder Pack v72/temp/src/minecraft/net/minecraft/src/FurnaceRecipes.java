...
public class FurnaceRecipes {
   ...
   private FurnaceRecipes() {
      ...
      this.func_77600_a(Item.field_77784_aq.field_77779_bT, new ItemStack(Item.field_77782_ar), 0.3F);
      this.func_77600_a(Item.field_77741_bi.field_77779_bT, new ItemStack(Item.field_77734_bj), 0.3F);
      this.func_77600_a(Item.field_77735_bk.field_77779_bT, new ItemStack(Item.field_77736_bl), 0.3F);
      this.func_77600_a(Item.field_77754_aU.field_77779_bT, new ItemStack(Item.field_77753_aV), 0.3F);
      this.func_77600_a(Block.field_71978_w.field_71990_ca, new ItemStack(Block.field_71981_t), 0.1F);
      this.func_77600_a(Item.field_77757_aI.field_77779_bT, new ItemStack(Item.field_77772_aH), 0.2F);
      this.func_77600_a(Block.field_72038_aV.field_71990_ca, new ItemStack(Item.field_77756_aW, 1, 2), 0.2F);
      this.func_77600_a(Block.field_71951_J.field_71990_ca, new ItemStack(Item.field_77705_m, 1, 1), 0.1F);
