...
public class EntityClientPlayerMP extends EntityPlayerSP {
   ...
   public void func_71166_b() {
      ...
      if(this.field_70154_o != null) {
         if(var14) {
            this.field_71174_a.func_72552_c(new Packet11PlayerPosition(this.field_70159_w, -999.0D, -999.0D, this.field_70179_y, this.field_70122_E));
         } else {
      ...
      } else if(this.field_71173_cl != this.field_70122_E) {
