...
public class GuiCreateWorld extends GuiScreen {
   ...
   public void func_73866_w_() {
      ...
      this.field_73887_h.add(this.field_73930_u = new GuiButton(2, this.field_73880_f / 2 - 75, 100, 150, 20, var1.func_74805_b("selectWorld.gameMode")));
      this.field_73887_h.add(this.field_73929_v = new GuiButton(3, this.field_73880_f / 2 - 75, 172, 150, 20, var1.func_74805_b("selectWorld.moreWorldOptions")));
      ...
      this.field_73887_h.add(this.field_73938_x = new GuiButton(7, this.field_73880_f / 2 + 5, 136, 150, 20, var1.func_74805_b("selectWorld.bonusItems")));
      ...
      this.field_73887_h.add(this.field_73936_z = new GuiButton(6, this.field_73880_f / 2 - 155, 136, 150, 20, var1.func_74805_b("selectWorld.allowCommands")));
   ...
   protected void func_73875_a(GuiButton p_73875_1_) {
      if(p_73875_1_.field_73742_g) {
         if(p_73875_1_.field_73741_f == 1) {
            ...
            this.field_73931_t = !this.field_73931_t;
            ...
            if(this.field_73931_t) {
               var8 = StringTranslate.func_74808_a();
               this.field_73929_v.field_73744_e = var8.func_74805_b("gui.done");
            } else {
               var8 = StringTranslate.func_74808_a();
               this.field_73929_v.field_73744_e = var8.func_74805_b("selectWorld.moreWorldOptions");
            }
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      if(this.field_73931_t) {
         ...
         this.func_73731_b(this.field_73886_k, var4.func_74805_b("selectWorld.allowCommands.info"), this.field_73880_f / 2 - 150, 157, 10526880);
         ...
         this.func_73731_b(this.field_73886_k, this.field_73920_A, this.field_73880_f / 2 - 100, 122, 10526880);
         this.func_73731_b(this.field_73886_k, this.field_73922_B, this.field_73880_f / 2 - 100, 134, 10526880);
      }
