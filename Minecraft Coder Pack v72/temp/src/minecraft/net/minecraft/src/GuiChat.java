...
public class GuiChat extends GuiScreen {
   ...
   protected void func_73869_a(char p_73869_1_, int p_73869_2_) {
      ...
      if(p_73869_2_ == 1) {
         ...
         this.field_73882_e.field_71456_v.func_73827_b().func_73758_b(19);
         ...
         if(var4 != null) {
            ...
            if(var5 != null) {
               if(this.field_73882_e.field_71474_y.field_74358_q) {
                  ...
                  this.field_73882_e.func_71373_a(new GuiChatConfirmLink(this, this, var4.func_78309_f(), 0, var4));
               } else {
