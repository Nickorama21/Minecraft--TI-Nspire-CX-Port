...
public class ModelSpider extends ModelBase {
   ...
   public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_) {
      ...
      this.field_78205_d.field_78808_h = -var7;
      this.field_78206_e.field_78808_h = var7;
      this.field_78203_f.field_78808_h = -var7 * 0.74F;
      this.field_78204_g.field_78808_h = var7 * 0.74F;
      this.field_78212_h.field_78808_h = -var7 * 0.74F;
      this.field_78213_i.field_78808_h = var7 * 0.74F;
      this.field_78210_j.field_78808_h = -var7;
      this.field_78211_k.field_78808_h = var7;
      float var8 = -0.0F;
      float var9 = 0.3926991F;
      this.field_78205_d.field_78796_g = var9 * 2.0F + var8;
      this.field_78206_e.field_78796_g = -var9 * 2.0F - var8;
      this.field_78203_f.field_78796_g = var9 * 1.0F + var8;
      this.field_78204_g.field_78796_g = -var9 * 1.0F - var8;
      this.field_78212_h.field_78796_g = -var9 * 1.0F + var8;
      this.field_78213_i.field_78796_g = var9 * 1.0F - var8;
      this.field_78210_j.field_78796_g = -var9 * 2.0F + var8;
      this.field_78211_k.field_78796_g = var9 * 2.0F - var8;
      float var10 = -(MathHelper.func_76134_b(p_78087_1_ * 0.6662F * 2.0F + 0.0F) * 0.4F) * p_78087_2_;
      float var11 = -(MathHelper.func_76134_b(p_78087_1_ * 0.6662F * 2.0F + 3.1415927F) * 0.4F) * p_78087_2_;
      float var12 = -(MathHelper.func_76134_b(p_78087_1_ * 0.6662F * 2.0F + 1.5707964F) * 0.4F) * p_78087_2_;
      float var13 = -(MathHelper.func_76134_b(p_78087_1_ * 0.6662F * 2.0F + 4.712389F) * 0.4F) * p_78087_2_;
      float var14 = Math.abs(MathHelper.func_76126_a(p_78087_1_ * 0.6662F + 0.0F) * 0.4F) * p_78087_2_;
      float var15 = Math.abs(MathHelper.func_76126_a(p_78087_1_ * 0.6662F + 3.1415927F) * 0.4F) * p_78087_2_;
      float var16 = Math.abs(MathHelper.func_76126_a(p_78087_1_ * 0.6662F + 1.5707964F) * 0.4F) * p_78087_2_;
      float var17 = Math.abs(MathHelper.func_76126_a(p_78087_1_ * 0.6662F + 4.712389F) * 0.4F) * p_78087_2_;
      this.field_78205_d.field_78796_g += var10;
      this.field_78206_e.field_78796_g += -var10;
      this.field_78203_f.field_78796_g += var11;
      this.field_78204_g.field_78796_g += -var11;
      this.field_78212_h.field_78796_g += var12;
      this.field_78213_i.field_78796_g += -var12;
      this.field_78210_j.field_78796_g += var13;
      this.field_78211_k.field_78796_g += -var13;
      this.field_78205_d.field_78808_h += var14;
      this.field_78206_e.field_78808_h += -var14;
      this.field_78203_f.field_78808_h += var15;
      this.field_78204_g.field_78808_h += -var15;
      this.field_78212_h.field_78808_h += var16;
      this.field_78213_i.field_78808_h += -var16;
      this.field_78210_j.field_78808_h += var17;
      this.field_78211_k.field_78808_h += -var17;
   }
}
