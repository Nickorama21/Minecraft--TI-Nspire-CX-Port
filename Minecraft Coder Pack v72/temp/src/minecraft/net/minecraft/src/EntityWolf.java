...
public class EntityWolf extends EntityTameable {
   ...
   public void func_70071_h_() {
      ...
      if(this.func_70026_G()) {
         ...
         if(this.field_70929_i == 0.0F) {
            this.field_70170_p.func_72956_a(this, "mob.wolf.shake", this.func_70599_aP(), (this.field_70146_Z.nextFloat() - this.field_70146_Z.nextFloat()) * 0.2F + 1.0F);
         }
   ...
   public boolean func_70085_c(EntityPlayer p_70085_1_) {
      ...
      if(this.func_70909_n()) {
         if(var2 != null && Item.field_77698_e[var2.field_77993_c] instanceof ItemFood) {
