...
public class RenderEngine {
   ...
   public int[] func_78346_a(String p_78346_1_) {
      TexturePackBase var2 = this.field_78366_k.func_77292_e();
   ...
   public int func_78341_b(String p_78341_1_) {
      ...
      if(var2 != null) {
         ...
         TexturePackBase var6 = this.field_78366_k.func_77292_e();
   ...
   public void func_78343_a() {
      ...
      while(var2.hasNext()) {
         ...
         if(var3.field_76850_b != var1) {
            var3.func_76845_a(this);
            var1 = var3.field_76850_b;
         }

         for(int var4 = 0; var4 < var3.field_76849_e; ++var4) {
            for(int var5 = 0; var5 < var3.field_76849_e; ++var5) {
               GL11.glTexSubImage2D(3553, 0, var3.field_76850_b % 16 * 16 + var4 * 16, var3.field_76850_b / 16 * 16 + var5 * 16, 16, 16, 6408, 5121, this.field_78358_g);
            }
         }
      }
