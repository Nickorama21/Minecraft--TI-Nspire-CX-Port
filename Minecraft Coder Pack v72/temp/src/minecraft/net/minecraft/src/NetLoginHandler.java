...
public class NetLoginHandler extends NetHandler {
   ...
   public void func_72467_a(Packet254ServerPing p_72467_1_) {
      try {
         String var2 = this.field_72534_f.func_71273_Y() + "\u00a7" + this.field_72534_f.func_71203_ab().func_72394_k() + "\u00a7" + this.field_72534_f.func_71203_ab().func_72352_l();
         InetAddress var3 = null;
         if(this.field_72538_b.func_74452_g() != null) {
            var3 = this.field_72538_b.func_74452_g().getInetAddress();
         }

         this.field_72538_b.func_74429_a(new Packet255KickDisconnect(var2));
         this.field_72538_b.func_74423_d();
         if(var3 != null && this.field_72534_f.func_71212_ac() instanceof DedicatedServerListenThread) {
            ((DedicatedServerListenThread)this.field_72534_f.func_71212_ac()).func_71761_a(var3);
         }
