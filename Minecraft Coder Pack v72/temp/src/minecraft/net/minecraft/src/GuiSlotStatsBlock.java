...
class GuiSlotStatsBlock extends GuiSlotStats {
   ...
   public GuiSlotStatsBlock(GuiStats p_i3074_1_) {
      ...
      while(var2.hasNext()) {
         ...
         if(GuiStats.func_74127_c(p_i3074_1_).func_77444_a(var3) > 0) {
            var4 = true;
         } else if(StatList.field_75929_E[var5] != null && GuiStats.func_74127_c(p_i3074_1_).func_77444_a(StatList.field_75929_E[var5]) > 0) {
            var4 = true;
         } else if(StatList.field_75928_D[var5] != null && GuiStats.func_74127_c(p_i3074_1_).func_77444_a(StatList.field_75928_D[var5]) > 0) {
            var4 = true;
         }
      ...
      this.field_77267_i = new SorterStatsBlock(this, p_i3074_1_);
   }
