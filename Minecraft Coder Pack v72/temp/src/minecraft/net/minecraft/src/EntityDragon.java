...
public class EntityDragon extends EntityDragonBase {
   ...
   public EntityDragon(World p_i3531_1_) {
      ...
      this.field_70966_a = 200;
      this.func_70606_j(this.field_70966_a);
   ...
   protected void func_70088_a() {
      super.func_70088_a();
      this.field_70180_af.func_75682_a(16, new Integer(this.field_70966_a));
   }
   ...
   public void func_70636_d() {
      ...
      if(this.field_70734_aK <= 0) {
         ...
         var26 = (this.field_70146_Z.nextFloat() - 0.5F) * 4.0F;
         var3 = (this.field_70146_Z.nextFloat() - 0.5F) * 8.0F;
         this.field_70170_p.func_72869_a("largeexplode", this.field_70165_t + (double)var1, this.field_70163_u + 2.0D + (double)var26, this.field_70161_v + (double)var3, 0.0D, 0.0D, 0.0D);
      } else {
         this.func_70969_j();
         ...
         if(this.field_70976_f < 0) {
            for(int var2 = 0; var2 < this.field_70979_e.length; ++var2) {
               this.field_70979_e[var2][0] = (double)this.field_70177_z;
               this.field_70979_e[var2][1] = this.field_70163_u;
            }
         }
         ...
         if(this.field_70170_p.field_72995_K) {
            if(this.field_70716_bi > 0) {
               var25 = this.field_70165_t + (this.field_70709_bj - this.field_70165_t) / (double)this.field_70716_bi;
               ...
               --this.field_70716_bi;
               this.func_70107_b(var25, var4, var6);
               this.func_70101_b(this.field_70177_z, this.field_70125_A);
            }
         } else {
            var25 = this.field_70980_b - this.field_70165_t;
            ...
            var4 /= (double)MathHelper.func_76133_a(var25 * var25 + var6 * var6);
            var33 = 0.6F;
            ...
            Vec3 var15 = Vec3.func_72437_a().func_72345_a(this.field_70980_b - this.field_70165_t, this.field_70981_c - this.field_70163_u, this.field_70978_d - this.field_70161_v).func_72432_b();
            Vec3 var40 = Vec3.func_72437_a().func_72345_a((double)MathHelper.func_76126_a(this.field_70177_z * 3.1415927F / 180.0F), this.field_70181_x, (double)(-MathHelper.func_76134_b(this.field_70177_z * 3.1415927F / 180.0F))).func_72432_b();
            ...
            Vec3 var23 = Vec3.func_72437_a().func_72345_a(this.field_70159_w, this.field_70181_x, this.field_70179_y).func_72432_b();
         ...
         var26 = (float)(this.func_70974_a(5, 1.0F)[1] - this.func_70974_a(10, 1.0F)[1]) * 10.0F / 180.0F * 3.1415927F;
         var3 = MathHelper.func_76134_b(var26);
         float var28 = -MathHelper.func_76126_a(var26);
   ...
   private void func_70969_j() {
      if(this.field_70992_bH != null) {
         ...
         } else if(this.field_70173_aa % 10 == 0 && this.field_70734_aK < this.field_70966_a) {
            ++this.field_70734_aK;
         }
      }
   ...
   private void func_70971_b(List p_70971_1_) {
      Iterator var2 = p_70971_1_.iterator();
   ...
   public boolean func_70965_a(EntityDragonPart p_70965_1_, DamageSource p_70965_2_, int p_70965_3_) {
      ...
      if(p_70965_2_.func_76346_g() instanceof EntityPlayer || p_70965_2_ == DamageSource.field_76378_k) {
         this.func_70964_e(p_70965_2_, p_70965_3_);
      }
   ...
   protected void func_70609_aI() {
      ...
      int var4;
      int var5;
      if(!this.field_70170_p.field_72995_K && this.field_70995_bG > 150 && this.field_70995_bG % 5 == 0) {
         var4 = 1000;
