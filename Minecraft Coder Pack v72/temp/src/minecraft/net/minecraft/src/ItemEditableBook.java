...
public class ItemEditableBook extends Item {
   ...
   public void func_77624_a(ItemStack p_77624_1_, List p_77624_2_) {
      if(p_77624_1_.func_77942_o()) {
         NBTTagCompound var3 = p_77624_1_.func_77978_p();
         NBTTagString var4 = (NBTTagString)var3.func_74781_a("author");
         if(var4 != null) {
            p_77624_2_.add("\u00a77" + String.format(StatCollector.func_74837_a("book.byAuthor", new Object[]{var4.field_74751_a}), new Object[0]));
         }
      }
