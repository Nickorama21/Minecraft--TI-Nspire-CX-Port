...
public class PathFinder {
   ...
   private int func_75855_a(Entity p_75855_1_, int p_75855_2_, int p_75855_3_, int p_75855_4_, PathPoint p_75855_5_) {
      ...
      for(int var7 = p_75855_2_; var7 < p_75855_2_ + p_75855_5_.field_75839_a; ++var7) {
         for(int var8 = p_75855_3_; var8 < p_75855_3_ + p_75855_5_.field_75837_b; ++var8) {
            for(int var9 = p_75855_4_; var9 < p_75855_4_ + p_75855_5_.field_75838_c; ++var9) {
               int var10 = this.field_75868_a.func_72798_a(var7, var8, var9);
               if(var10 > 0) {
                  if(var10 == Block.field_72005_bk.field_71990_ca) {
                     var6 = true;
                  } else if(var10 != Block.field_71942_A.field_71990_ca && var10 != Block.field_71943_B.field_71990_ca) {
                     if(!this.field_75865_e && var10 == Block.field_72054_aE.field_71990_ca) {
                        return 0;
                     }
                  } else {
                  ...
                  if(!var11.func_71918_c(this.field_75868_a, var7, var8, var9) && (!this.field_75862_f || var10 != Block.field_72054_aE.field_71990_ca)) {
                     if(var10 == Block.field_72031_aZ.field_71990_ca || var10 == Block.field_71993_bv.field_71990_ca) {
                        return -3;
                     }
                     ...
                     Material var12 = var11.field_72018_cp;
                     if(var12 != Material.field_76256_h) {
                        return 0;
                     }
