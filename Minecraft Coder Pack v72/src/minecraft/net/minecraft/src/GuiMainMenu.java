...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        {
            this.controlList.add(new GuiButton(0, this.width / 2 - 100, var4 + 24, var2.translateKey("menu.options")));
        }
        else
        {
            this.controlList.add(new GuiButton(0, this.width / 2 - 100, var4 + 24 + 12, 98, 20, var2.translateKey("menu.options")));
            this.controlList.add(new GuiButton(4, this.width / 2 + 2, var4 + 24 + 12, 98, 20, var2.translateKey("menu.quit")));
        }
