...
public class DemoWorldManager extends ItemInWorldManager
{
    ...
    public void func_73075_a()
    {
        ...
        if (!this.field_73105_c && this.field_73102_f > 20)
        {
            ...
            this.field_73090_b.serverForThisPlayer.sendPacketToPlayer(new Packet70GameEvent(5, 0));
        }
        ...
        if (var1 % 24000L == 500L)
        {
            if (var3 <= 6L)
            {
                this.field_73090_b.sendChatToPlayer(this.field_73090_b.translateString("demo.day." + var3, new Object[0]));
            }
        }
        else if (var3 == 1L)
        {
            if (var1 == 100L)
            {
                this.field_73090_b.serverForThisPlayer.sendPacketToPlayer(new Packet70GameEvent(5, 101));
            }
            else if (var1 == 175L)
            {
                this.field_73090_b.serverForThisPlayer.sendPacketToPlayer(new Packet70GameEvent(5, 102));
            }
            else if (var1 == 250L)
            {
                this.field_73090_b.serverForThisPlayer.sendPacketToPlayer(new Packet70GameEvent(5, 103));
            }
        }
        else if (var3 == 5L && var1 % 24000L == 22000L)
        {
            this.field_73090_b.sendChatToPlayer(this.field_73090_b.translateString("demo.day.warning", new Object[0]));
        }
    }
    ...
    private void sendDemoReminder()
    {
        ...
        {
            this.field_73090_b.sendChatToPlayer(this.field_73090_b.translateString("demo.reminder", new Object[0]));
